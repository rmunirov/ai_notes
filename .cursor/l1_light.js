...
const D={bg:{r:.972,g:.972,b:.976},sf:{r:1,g:1,b:1},hi:{r:.935,g:.938,b:.946},t:{r:.1,g:.105,b:.125},m:{r:.44,g:.46,b:.52},a:{r:.545,g:.365,b:.965},b:{r:.87,g:.875,b:.895},w:{r:1,g:1,b:1},x:{r:.92,g:.91,b:.985}};
...
const root=V("Светлая тема");root.fills=[{type:"SOLID",color:D.bg}];root.resize(1280,800);root.counterAxisSizingMode="FIXED";
